...
- screen: Inventory workspace only — `QM.10.10.00` Quality Preferences (Preferences), `QM.20.10.00` Inspection Plans (Profiles), `QM.30.10.00` Inspection Orders (Transactions), `QM.30.20.00` Non-Conformance Reports (Transactions), `QM.40.10.00` Quality Queue GI (Inquiries); ScreenIDs QM101000 QM201000 QM301000 QM302000 QM401000; Pattern B PXScreen HTML+TS four QM forms; Pattern A IN202500_QMS Usr* fields; ! QMS MUIWorkspace; ! QM000000; ! Configuration; REST host `Pages/QM/*.aspx` stubs; ScreenId URLs open Modern UI
