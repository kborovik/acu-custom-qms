...
def quality_queue_seed_sql(cid: int) -> str:
    ...
    return (
        ...
        "CreatedByID, CreatedDateTime, CreatedByScreenID, LastModifiedByID, "
        "LastModifiedDateTime, LastModifiedByScreenID, NoteID, CompanyMask) VALUES "
        f"(@cid, @did, 1, 1, 1, N'Item', N'inventoryCD', N'Inventory', 1, 0, NULL, 0, 1, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
        f"(@cid, @did, 2, 2, 1, N'Order', N'lotSerialNbr', N'Lot', 1, 0, NULL, 0, 1, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
        f"(@cid, @did, 3, 3, 1, N'Order', N'receiptNbr', N'Receipt', 1, 0, NULL, 0, 1, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
        f"(@cid, @did, 4, 4, 1, N'Vendor', N'acctCD', N'Vendor', 1, 0, NULL, 0, 1, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
        f"(@cid, @did, 5, 5, 1, N'Order', N'planID', N'Plan', 1, 0, NULL, 0, 1, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
        ...
        f"(@cid, @did, 8, 8, 1, N'Order', N'status', N'Order Status', 1, 0, NULL, 0, 0, N'MAX', NEWID(), '{nil}', GETDATE(), 'QM401000', '{nil}', GETDATE(), 'QM401000', NEWID(), @mask), "
